package it.cardiotools.abmedical.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("cardioTool");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("cardioTool");
        ...
        config.getMapConfigs().put("it.cardiotools.abmedical.domain.*", initializeDomainMapConfig(jHipsterProperties));
